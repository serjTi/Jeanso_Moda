...
public class Const {
    ...
    public static final String COLOR_ATTRIBUTE = "Цвет";
    public static final String BRAND_ATTRIBUTE = "Бренд";
    public static final String SIZE_ATTRIBUTE = "Размеры";
    ...
    public static final String MEN_CATEGORY = "5";
    public static final String WOMEN_CATEGORY = "3";

    public static final String MY_PREFERENCES = "MY_PREFERENCES";
    public static final String SAVED_XML_DATABASE = "SAVED_XML_DATABASE";
}
